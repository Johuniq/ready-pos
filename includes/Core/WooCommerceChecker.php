...
class WooCommerceChecker {
	...
	public function render_wc_missing_notice() {
		...
		$message = __( 'Ready POS Pro requires WooCommerce to be installed and active. Please install or activate WooCommerce to use Ready POS Pro.', 'ready-pos-for-woocommerce' );
