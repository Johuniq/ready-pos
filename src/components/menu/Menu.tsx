...
export const menu = tv({
  slots: {
    menuPopoverClass:
      "border-border-default bg-popover text-popover-foreground data-[entering]:animate-fade data-[exiting]:animate-fadeOut overflow-auto rounded-md border shadow-border",
    menuContentClass: "flex h-fit w-56 flex-col gap-2 p-2 outline-none",
    item: "data-[focused]:text-primary border border-transparent data-[focused]:border data-[focused]:border-border-default data-[focused]:shadow-border font-medium relative flex cursor-pointer justify-between rounded-md p-2 outline-none text-foreground hover:bg-accent hover:text-accent-foreground",
  },
});
